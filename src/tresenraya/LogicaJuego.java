...
public class LogicaJuego {
     ...
     * jugando.Se valorará el código limpio, comprensible, organizado y
     * optimizado; se puede implementar en 3 o 4 líneas de código Obligatorio
     ...
     * @param jp (panel donde está situado el tablero) variable local String
     * mensajeGanador
     */   
     ...
     * variable GLOBAL a la clase LogicaJuego: habilitado
     *
     * @param jp (Panel dónde se sitúa el tablero de juego)
     */
    ...
    /**
     * En ponerFicha, Insertaremos la ficha en la posición correspondiente de la
     * matriz Llamaremos al método pintarFicha
     *
     * @param matriz (Tablero de juego)
     * @param x (Posición x en el tablero)
     * @param y (Posición y en el tablero)
     * @param bt (Botón pulsado) turno (para saber que ficha poner)
     */
